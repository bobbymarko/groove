...
const MOUNTAIN_FAR := Color("e3c4d6")
const MOUNTAIN_FAR2 := Color("d0b3cf")
const MOUNTAIN_MID := Color("b89ac4")
const MOUNTAIN_MID2 := Color("9d9cc8")
const MOUNTAIN_NEAR := Color("8391c2")
const SKY_MID := Color("b7b5dc")
const SKY_LOW := Color("d6bfd9")

const PINE := Color("34667a")
const PINE_LIGHT := Color("62a0ad")
const PINE_DARK := Color("1d3d4a")
