...
- R32. Distribution: public repo https://github.com/bobbymarko/groove (MIT); release v0.0.1 is a universal macOS zip exported with the macOS preset (ad-hoc signed, not notarized; Gatekeeper needs right-click Open). Export requires the Godot 4.7.2 templates and ETC2/ASTC import enabled. (2026-09-04.)
