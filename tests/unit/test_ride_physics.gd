...
func test_steady_speed_orders() -> void:
	...
	var climb_200 := RidePhysics.steady_speed(200.0, 6.0)
	var descent_200 := RidePhysics.steady_speed(200.0, -4.0)
	assert_true(flat_300 > flat_200)
	assert_true(climb_200 < flat_200)
	assert_true(descent_200 > flat_200)
