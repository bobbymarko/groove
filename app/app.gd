...
const TUNING_SPEC := [
	...
	["shadow_strength", "Shadow strength", 0.0, 1.0, 0.01, 0.63],
	["sun_elevation", "Noon sun height (°)", 5.0, 75.0, 1.0, 15.0],
	["sun_azimuth", "Noon sun direction (°)", 0.0, 360.0, 1.0, 96.0],
	["sun_energy", "Sun brightness", 0.2, 1.6, 0.01, 0.34],
	...
	["tree_density", "Tree density", 0.2, 3.0, 0.05, 3.0],
